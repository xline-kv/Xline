...
mod test {
    ...
    use crate::{
        rpc::RequestOp,
        storage::{db::DBProxy, kvwatcher::watcher},
    };
    ...
    async fn init_store(db: Arc<DBProxy>) -> Result<Arc<KvStore<DBProxy>>, ExecuteError> {
    ...
    fn init_empty_store(db: Arc<DBProxy>) -> Arc<KvStore<DBProxy>> {
