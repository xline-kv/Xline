...
use super::prelude::{ClientConfig, CurpConfig, XlineServerTimeout};
...
pub struct ClusterConfig {
    ...
    #[getset(get = "pub")]
    #[serde(default = "XlineServerTimeout::default")]
    server_timeout: XlineServerTimeout,
...
impl Default for ClusterConfig {
    ...
    fn default() -> Self {
        Self {
            ...
            server_timeout: XlineServerTimeout::default(),
...
pub type RangeBound = std::ops::Range<u64>;
